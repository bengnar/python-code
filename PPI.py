...
# ax = fig.add_subplot(111);
# x_cued = []
# for i, j in df[df.cued=='cued'].iterrows():
#     x_cued.append(j['resp'])
# x_cued = np.array(x_cued)
# ax.plot(x_cued.mean(0), 'b')

# x_uncued = []
# for i, j in df[df.cued=='uncued'].iterrows():
#     x_uncued.append(j['resp'])
# x_uncued = np.array(x_uncued)
# ax.plot(x_uncued.mean(0), 'r')
